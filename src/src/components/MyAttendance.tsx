...
const MyAttendance = ({ userId, userRole }: MyAttendanceProps) => {
  ...
  const presentDays = attendance
    ...
    .map((d) => parseUTCDate(d.attendance_date));
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <Calendar
                ...
                modifiersClassNames={{
                  present:
                    "bg-success text-success-foreground hover:bg-success hover:text-success-foreground !bg-success !text-success-foreground",
                  absent:
                    "bg-destructive text-destructive-foreground hover:bg-destructive hover:text-destructive-foreground !bg-destructive !text-destructive-foreground",
                }}
              />
