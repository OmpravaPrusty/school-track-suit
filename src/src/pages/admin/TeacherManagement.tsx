...
const TeacherManagement = () => {
  ...
  const fetchData = async (page: number) => {
    ...
    try {
      ...
      query = query
        .order("profiles(full_name)", { ascending: sortOrder === "asc" })
        .range(from, to);
      ...
      <Card>
              ...
              {filteredTeachers.map((teacher) => (
                <TableRow key={teacher.id}>
                  <TableCell className="font-medium">
                    {formatNameToTitleCase(teacher.full_name)}
                  </TableCell>
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                              ...
                              permanently delete this teacher and all their
                              associated data.
                            </AlertDialogDescription>
                          </AlertDialogHeader>
                          <AlertDialogFooter>
        ...
        <div className="flex justify-between items-center p-4 border-t">
          <span className="text-sm text-muted-foreground">
            ...
            {Math.ceil(totalTeachers / TEACHERS_PER_PAGE)}
          </span>
          <div className="flex gap-2">
            <Button
              variant="outline"
            ...
            <Button
              ...
              onClick={() =>
                setCurrentPage((prev) =>
                  Math.min(
                    prev + 1,
                    Math.ceil(totalTeachers / TEACHERS_PER_PAGE) - 1
                  )
                )
              }
