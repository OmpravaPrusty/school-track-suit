...
const SchoolManagement = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (formData.contact_phone && (!/^\d{10}$/.test(formData.contact_phone))) {
      toast({ title: "Error", description: "Contact phone must be exactly 10 digits.", variant: "destructive" });
      return;
    }
                      ...
                      {/* <AlertDialog>
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                              This action cannot be undone. This will permanently delete this school and all its associated data.
                            </AlertDialogDescription>
                          </AlertDialogHeader>
                          <AlertDialogFooter>
                            <AlertDialogCancel>Cancel</AlertDialogCancel>
                            <AlertDialogAction onClick={() => handleDelete(school.id)}>Continue</AlertDialogAction>
                          </AlertDialogFooter>
                        </AlertDialogContent>
                      </AlertDialog> */}
                    </div>
