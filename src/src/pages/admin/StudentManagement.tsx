...
const StudentManagement = () => {
  ...
  const handleEditStudent = async () => {
    ...
    if (selectedStudent.phone) {
      const phoneDigits = selectedStudent.phone.replace(/\D/g, "");
      if (phoneDigits.length !== 10) {
        toast({
          title: "Invalid Phone Number",
          description: "Phone number must be exactly 10 digits.",
      ...
      // Normalize phone to digits only
      selectedStudent.phone = phoneDigits;
    }
            ...
            <div className="grid grid-cols-2 gap-4 py-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setNewStudent((prev) => ({ ...prev, school_id: value }))
                  }
                >
                  <SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setNewStudent((prev) => ({ ...prev, batch_id: value }))
                  }
                >
                  <SelectTrigger>
                ...
                {filteredStudents.map((student) => (
                  <TableRow key={student.id} className="hover:bg-muted/30">
                    <TableCell className="font-medium">
                      {formatNameToTitleCase(student.full_name)}
                    </TableCell>
                    <TableCell>{student.students?.student_id || "-"}</TableCell>
                    <TableCell>{student.email}</TableCell>
                    <TableCell>
                      {student.students?.batches?.name || "-"}
                    </TableCell>
                    <TableCell>
                      {student.students?.schools?.name || "-"}
                    </TableCell>
                    <TableCell>
                          ...
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              ...
                              <AlertDialogDescription>
                                ...
                                permanently delete this student and all their
                                associated data.
                              </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
            ...
            <Button
              ...
              onClick={() =>
                setCurrentPage((prev) =>
                  Math.min(
                    prev + 1,
                    Math.ceil(totalStudents / STUDENTS_PER_PAGE) - 1
                  )
                )
              }
                  ...
                  onValueChange={(value) =>
                    setSelectedStudent((prev) =>
                      prev
                        ? {
                            ...prev,
                            students: { ...prev.students!, school_id: value },
                          }
                        : null
                    )
                  }
                  ...
                  onValueChange={(value) =>
                    setSelectedStudent((prev) =>
                      prev
                        ? {
                            ...prev,
                            students: { ...prev.students!, batch_id: value },
                          }
                        : null
                    )
                  }
